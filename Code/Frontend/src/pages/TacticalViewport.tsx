                ...
                <aside className="w-72 bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 flex flex-col overflow-y-auto shrink-0">
                    ...
                    <section className="p-4 border-b border-slate-200 dark:border-slate-800">
                        ...
                        <div className="flex items-center gap-2 mb-3">
                            <input type="range" min="1" max="50" value={data.drones.length} readOnly className="flex-1 accent-cyan-500" />
                    ...
                    <section className="p-4 border-b border-slate-200 dark:border-slate-800">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex flex-col text-[9px] text-slate-500 font-mono gap-4">
                            ...
                            <input
                                ...
                                className="accent-cyan-500 flex-1 h-32"
                                style={{ writingMode: 'vertical-lr', direction: 'rtl' }}
                                aria-label="Depth slider"
                            />
                            <span className="text-sm font-mono font-bold text-cyan-500">{depthValue.toFixed(1)}m</span>
                        </div>
                    </section>
