...
def main():
    ...
    parser.add_argument("--mode", type=str, default="PATROL", choices=["PATROL", "ATTACK", "DEFEND", "ENCIRCLE", "SHIELD", "SEARCH", "FLASH_EXPANSION", "SCHOOLING", "PREDATOR_PACK", "EXPLORATION"], help="Initial Swarm combat mode")
